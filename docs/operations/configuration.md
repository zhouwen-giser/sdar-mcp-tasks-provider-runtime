...
| `TASK_NOTIFICATION_POLL_INTERVAL_MS`           | `500`                   | Task 通知的单一全局轮询间隔                       |
| `TASK_NOTIFICATION_MAX_SUBSCRIPTIONS`          | `256`                   | Task 通知活动订阅全局上限                         |
| `TASK_NOTIFICATION_MAX_SUBSCRIPTIONS_PER_AUTH` | `32`                    | 每个授权域的活动订阅上限                          |
| `TASK_NOTIFICATION_MAX_TASK_BINDINGS`          | `4096`                  | 订阅与 Task 绑定的全局上限                        |
| `TASK_NOTIFICATION_MAX_QUEUE_MESSAGES`         | `64`                    | 每个流的有界队列消息上限                          |
| `TASK_NOTIFICATION_MAX_QUEUE_BYTES`            | `1048576`               | 每个流的有界队列字节上限                          |
| `TASK_NOTIFICATION_BATCH_SIZE`                 | `256`                   | 每个通知批次加载的最大 Task 数                    |
