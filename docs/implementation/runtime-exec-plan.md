...
| R4    | Availability, full idempotency, admission recovery/concurrency                     | one external execution per duplicate/concurrent call | implementation complete; CI evidence pending   |
