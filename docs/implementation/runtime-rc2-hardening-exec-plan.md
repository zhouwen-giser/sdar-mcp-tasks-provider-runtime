...
| H4    | immutable Snapshot resolution and Adapter identity validation                 | T-017..T-022; Manifest v1->v2 recovery                        | implementation complete; CI pending |
...
- 2026-07-17 H4: historical execution, scheduling, recovery and control now resolve and
  ...
  produce a Runtime audit observation/outbox event and metric without rebinding the Task.
