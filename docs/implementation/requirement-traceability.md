...
| RQ-TIME               | Profile 12-15                      | R5             | domain timing, PostgreSQL claims, DurableScheduler                | fake-clock scheduled/window/deadline/multi-worker integration | implementation complete; CI pending           |
