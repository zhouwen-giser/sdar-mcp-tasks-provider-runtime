...
| --------------------- | ---------------------------------- | -------------- | ----------------------------------------------------------------- | -------------------------------------------------------------- | -------------------------------------------- |
| RQ-MCP                | Profile 5-8, 21-24, 33             | R2, R3, R6     | `packages/mcp-protocol`, `apps/runtime`                           | `tests/contract/mcp`, `tests/e2e`; `test:contract`, `test:e2e` | in progress (R2 initialize/tools verified)   |
