...
| RQ-ADAPTER            | Adapter 4-15                       | R1-R8          | Proto, gateway and durable TypeScript/Python examples           | Proto contract and dual-language P0-P4 conformance            | R8 implementation complete; exit CI pending |
...
| RQ-CONFORMANCE        | Profile 37-39; Adapter 19-21       | R8, R9         | `packages/conformance-testkit`, both durable example Adapters   | P0-P4 JSON reports and identical dual-language E2E            | R8 implementation complete; exit CI pending |
