...
| RC2-OPS-01         | F-014/F-015       | H7    | component probes; bounded limiter; ADR-010                                    | T-041..T-043; E2E 4/4 local                            | implementation; full CI pending             | IN_PROGRESS |
| RC2-DB-01          | F-016             | H7    | migration 012; short claim/CAS; RPC outside PoolClient                        | T-044 + 001-011 upgrade; integration 57/57 local       | implementation; full CI pending             | IN_PROGRESS |
| RC2-IMAGE-01       | F-017             | H7    | frozen install; prod prune; reproducible image audit                          | T-045; Linux 327,026,557 bytes/non-root/reproducible   | implementation; threshold repair CI pending | IN_PROGRESS |
| RC2-MCP-01         | F-018             | H7    | explicit SDK 1.29 stateless transport; no session notification claim          | official multi-client/repeated POST T-046 local        | implementation; full CI pending             | IN_PROGRESS |
| RC2-MIGRATION-01   | all schema        | H8    | published 001-006 frozen; rc.2 migrations append-only through 012             | rc.1 data upgrade passed; full T-047 pending           | pending                                     | OPEN        |
