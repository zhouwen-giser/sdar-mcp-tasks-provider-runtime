...
| RC2-IMAGE-01       | F-017             | H7    | frozen install; prod prune; reproducible image audit                          | T-045; 97,150,847 bytes/non-root/reproducible local    | implementation; full CI pending             | IN_PROGRESS |
