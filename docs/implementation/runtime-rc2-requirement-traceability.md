...
| RC2-WIRE-01        | F-010/F-011/F-012 | H6    | typed hierarchy/mapper; retained output validator; ADR-009                    | official MCP/wire T-031..T-039; integration 54/54      | local implementation; remote CI pending     | IN_PROGRESS  |
| RC2-COMPAT-01      | F-013             | H6    | official ttl/pollInterval; namespaced aliases; strict TTL mapping             | official client + raw wire T-040                       | local implementation; remote CI pending     | IN_PROGRESS  |
