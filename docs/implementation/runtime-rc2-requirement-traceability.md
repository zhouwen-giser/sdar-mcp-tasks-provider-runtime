...
| ------------------ | ----------------- | ----- | ----------------------------------------------------------------------------- | ----------------------------------------------------- | ----------- | ------------ |
| RC2-CONTROL-01     | F-001/F-009       | H1    | command journal currently lacks claim/retry recovery                          | T-001..T-006,T-029,T-030; H0 red cancel latency guard | pending     | RED_BASELINE |
| RC2-TIME-01        | F-002             | H2    | immediate watchdog absent                                                     | T-007..T-009; H0 red watchdog guard                   | pending     | RED_BASELINE |
| RC2-TIME-02        | F-003             | H2    | scheduled retryable reject currently terminalizes                             | T-010..T-013; H0 red retry guard                      | pending     | RED_BASELINE |
| RC2-OBS-01         | F-004             | H3    | direct window/reject updates omit Observation/Outbox; adapter revision reused | T-014..T-016; H0 red atomic-transition guard          | pending     | RED_BASELINE |
| RC2-SNAPSHOT-01    | F-005             | H4    | Scheduler/Recovery currently resolve current Manifest                         | T-017,T-018; H0 red snapshot guard                    | pending     | RED_BASELINE |
| RC2-IDENTITY-01    | F-006             | H4    | centralized Snapshot/Ack identity validator absent                            | T-019..T-022; H0 red identity guard                   | pending     | RED_BASELINE |
