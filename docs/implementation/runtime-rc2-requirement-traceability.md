...
| RC2-RELEASE-01     | all               | H9    | rc.2 versions, `verify:rc2`, docs, capacity and 50-test matrix                | local T-050 matrix green; final CI/tag pending         | H9 implementation                           | IN_PROGRESS |
