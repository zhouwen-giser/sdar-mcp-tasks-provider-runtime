...
| RC2-TTL-01         | F-007             | H5    | migration 011; renewable active handles; logical expiry and SKIP LOCKED purge | PostgreSQL/MCP T-023..T-026                            | implementation complete; CI pending         | IN_PROGRESS  |
| RC2-READ-01        | F-008             | H5    | persisted-first get; transient stale meta; background Reconcile               | PostgreSQL/gRPC T-027,T-028                            | implementation complete; CI pending         | IN_PROGRESS  |
