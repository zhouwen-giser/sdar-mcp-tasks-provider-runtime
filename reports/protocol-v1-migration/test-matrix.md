...
Audited implementation commit: `0e54fdb`

Command: `pnpm verify:v2`

Result: PASS (exit code 0, 464.5 seconds)
...
| Runtime image                  | non-root, 99,843,505 bytes, reproducible filesystem/config                                         | PASS       |
| Unit                           | 18 files, 74 tests                                                                                 | PASS       |
...
| Adapter conformance            | TypeScript and Python expanded Adapter profile                                                     | PASS       |
