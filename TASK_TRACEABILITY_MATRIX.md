...
|---|---|---|---|---|---|
| RQ-MCP | Profile 5-8、33 | R2-R6 | `packages/mcp-protocol`, `apps/runtime` | contract/e2e | IN PROGRESS (R6 IMPLEMENTED) |
...
| RQ-STATE | Profile 5、17、24；Runtime 5 | R3-R6 | `packages/domain`, `packages/task-engine` | state matrix/terminal CAS | IN PROGRESS (R6 IMPLEMENTED) |
...
| RQ-CANCEL | Profile 23、36 | R6-R7 | task control/Adapter gateway | safe-stop/race | IN PROGRESS (R6 IMPLEMENTED) |
| RQ-INPUT | Profile 22 | R6 | task engine/PostgreSQL repositories | update/idempotency | IN PROGRESS (R6 IMPLEMENTED) |
| RQ-IDEMP | Profile 29 | R3-R5 | advisory-lock persistence/domain | duplicate/concurrent/reconcile | VERIFIED (R5 CI) |
| RQ-OBS | Profile 17-18、32 | R6 | observation/outbox repositories | revision/delivery | IN PROGRESS (R6 IMPLEMENTED) |
